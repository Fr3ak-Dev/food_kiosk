        ...
        <div className="shadow space-y-1 p-4 bg-white  border-t border-gray-200 ">
            <div className="space-y-4">
                ...
                <div className="flex gap-5 px-10 py-2 bg-gray-100 w-fit rounded-lg">
                    ...
                    >
                        <MinusIcon className="h-6 w-6 p-0.5 bg-indigo-400 hover:bg-indigo-600 text-white rounded-lg cursor-pointer" />
                    </button>
                    ...
                    <button
                        ...
                        className="disabled:opacity-20"
                    >
                        <PlusIcon className="h-6 w-6 p-0.5 bg-indigo-400 hover:bg-indigo-600 text-white rounded-lg cursor-pointer" />
                    </button>
                </div>
